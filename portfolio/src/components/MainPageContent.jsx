...
const MainPageContent = () =>{
    ...
    <div className="flex flex-col-reverse md:flex-row gap-10 items-center justify-center px-4 md:px-15 md:py-20 py-10">
        ...
        <div data-aos="fade-right" className="introduction-container flex flex-col gap-5 ">
        ...
        <div 
        data-aos="fade-left"
        className="image-container size-75 md:size-150 transition-transform duration-500 hover:scale-105 active:scale-110">
